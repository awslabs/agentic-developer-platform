...
placeholder row to DDB, acks the message. Real triage logic is a follow-up
issue -- but the plumbing (IAM, queues, table, networking) is exercised here.
"""
...
def run() -> None:
    ...
    sqs.send_message(
        ...
        MessageBody=json.dumps(
            {"artifact_id": artifact_id, "stage": "triage", "status": "stub-ok"}
        ),
    ...
    print(f"triage stub handled {artifact_id}")
